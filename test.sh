...
ARGS="--data_name=$DATA_NAME --image_folder=$IMAGE_FOLDER --noisy_image_folder=$NOISY_IMAGE_FOLDER --model_name=$MODEL_NAME --model_file=$MODEL_FILE --patch_size=$PATCH_SIZE --state_num=$STATE_NUM"
